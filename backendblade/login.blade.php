...
<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset('backend/assets/imgs/theme/logo-color.svg') }}" />
        <!-- Template CSS -->
        ...
        <main>
            ...
            <section class="content-main ">
                ...
                <div class="d-flex justify-content-center">
                    <img class="text-center" src="{{ asset('backend/assets/imgs/myCustom/download.png') }}" alt="">
                  </div>
                ...
                <div class="card mx-auto card-login mt-80">
                    <div class="card-body">
                        ...
                        <form id="admin_login_form">
                            ...
                            <!-- form-group// -->
                            <div class="mb-3">
                                <a href="{{ route('admin.rememberPassword') }}" class="float-end font-sm text-muted">Forgot password?</a>
                                <label class="form-check">
                                    <input  style="background-color: #52b467 !important;" name="remember"  type="checkbox" class="form-check-input" checked="" />
                                    <span class="form-check-label">Remember</span>
                                </label>
                            </div>
                            <!-- form-group form-check .// -->
                            <div class="mb-4">
                                <button style="background-color: #52b467 !important;" id="login_button" type="button" class="btn btn-primary w-100">Login</button>
