                    ...
                    <div class="col-md-12 col-lg-12 " style="color: #000000;">
                            ...
                            <div class="row" style="padding-top: 2%; padding-left:2%;">
                              ...
                              <img src="{{ asset('assets/img/presentation.png') }}" style="width:8%; height:35%;margin-top: 1%; " alt="logo" class="icon1"/>
                                  <div class="col-md-3">
                                  <span style="font-size:22px;font-weight:bold;color:#210555">{{ trans('messages.Technical') }}</span><br>
                                  <div class="p" style="margin-top: -8px;"> <span style="font-size:16px;font-weight:bold;">{{ trans('messages.Session') }}</span></div>
                                  </div>


                                  <img src="{{ asset('assets/img/meganew.png') }}" style="width:8%; height:35%;margin-top: 1%;" alt="logo" class="icon1"/>
                                  <div class="col-md-3">
                                    <a style="color:black !important;" href="{{ route('web.ta.programes') }}">
                                    <span style="font-size:22px;font-weight:bold;color:#210555">{{ trans('messages.Awareness') }}</span><br>
                                    <div class="p" style="margin-top: -8px;"><span style="font-size:16px;font-weight:bold;">{{ trans('messages.Programme') }}</span></div>
                                    </a>
                                  </div>
                                  <img src="{{ asset('assets/img/rego.png') }}" style="width:8%; height:35%; padding-top: 5px;" alt="logo" class="icon1"/>
                                  <div class="col-md-3 ">
                                    <span style="font-size:22px;font-weight:bold;color:#210555">{{ trans('messages.Officer') }}</span><br>
                                    <div class="p" style="margin-top: -8px;"><span style="font-size:16px;font-weight:bold;">{{ trans('messages.Registeration') }}</span></div>
                                  </div>
                    ...
                    <div class="col-md-12 col-lg-12 " style="color: #000000;">
                        ...
                        <div class="row" style="padding-top: 6%; padding-left:2%;">
                            ...
                            <div class="d-flex justify-content-between align-items-center breaking-news bg-white">
                                ...
                                <div class="d-flex flex-row flex-grow-1 news"><span class="d-flex align-items-center">&nbsp; <a href="{{ url('news/ta/more') }}" class="btn btn-primary ">செய்தி ஊட்டல்</a></span></div>
                            </div>
                            <style>
                               .news{
                                width: 230px;
...
<div class="container-fluid">
    <div class="row">
                ...
                <section class="row" >
                    ...
                    <div class="col-md-10 background-white py-3 rtr" style="background-color: #fff; margin-left:4%; margin-top: -60px;">
                        <div class="clearfix">
                            ...
                            <h6 style="padding-top: 15px;"><b style="color: #210555;font-family: 'Open Sans', sans-serif; text-transform: uppercase;">{{ $evt->event_title }}</b></h6>
                            <p class="d-inline" style="font-size: 15px;  font-family: 'Oswald', sans-serif;" > <!--have to figure out how to wrap this-->
                                {{-- {{ substr(strip_tags($evt->event_description), 0, 220) }} --}}
                                {{ $evt->event_description }}
                                      <br>
                                    <a href="{{ url('read/ta/more') }}" class="btn btn-primary " style="margin-top: 2%;">தொடர்ந்து படி</a>
      ...
      <div class="col-sm-3 col-md-6 col-lg-4" >
        <a href="{{ url('web/ta/beneficiary/form') }}">
