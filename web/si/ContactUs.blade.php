...
@section('content')
                ...
                <div class="container d-flex justify-content-center mt-100">
                    <div class="row">
                        ...
                        padding-bottom: 10%">
                                    ...
                                    <p class="para-1" style="color: #000000;"> සුබසාධන ප්‍රතිලාභ මණ්ඩලය <br> මුදල් අමාත්‍යාංශය, ආර්ථික ස්ථායීකරණ <br> සහ
                                        ජාතික ප්‍රතිපත්ති<br>1 වන මහල, නව ගොඩනැගිල්ල,<br>කොළඹ 01,<br>ශ්‍රී ලංකාව</p>
                                    </p>
    ...
    <div class="row id">
        ...
        <div class="mf-section-title text-center dark large-size margbtm20">
            <h1 style="color:black;font-weight:bold;font-family: 'PT Serif', serif; font-size: 16px;">අප සොයන්න</h1>
            ...
            <div class="col-md-12">
              <div class="form h-100">
                ...
                <form class="mb-5"  id="contactForm" name="contactForm">
                    @csrf
                  <div class="row">
                    <label for="" class="col-form-label"><h2>අපව අමතන්න</h2></label>
                    <div class="col-md-6 form-group mb-3">
                      <label for="" class="col-form-label">නම *</label>
                      <input type="text" class="form-control" name="name" id="name" placeholder="Your name">
                    </div>
                    <div class="col-md-6 form-group mb-3">
                      <label for="" class="col-form-label">විද්යුත් තැපෑල *</label>
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group mb-3">
                      <label for="message" class="col-form-label">පණිවුඩය *</label>
                      <textarea class="form-control" name="message" id="message" cols="30" rows="4"  placeholder="Write your message"></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12 form-group">
                        <button type="button" class="btn btn-md rounded btn-primary" id="send">පණිවුඩය යවන්න</button>
