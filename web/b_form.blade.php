            ...
            <div style="padding-top: 5%;">
                ...
                <fieldset>
                    ...
                    <div class="fieldset-content">
                        <div class="form-row">
                            <label class="form-label">Applicant Full name</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-input">Include with surname*</span>
                                </div>
                        ...
                        <div id="gendersection">Gender <span id='gender'></div>

                        <div id="dobsection">DOB <span id='dob'></div>
                    <div class="row" style="padding-top: 3%;">
                        <div class="form-date">
                            ...
                            <div class="mb-10">
                                ...
                                <div class="row" style="padding-top: 3%;">
                                    <div class="col">
                                        <label for="birth_date" class="form-label">Province</label>
                                    ...
                                    <div class="col">
                                        <label for="birth_date" class="form-label">District</label>
                                        <!--- Sri Lanka states -->
                                ...
                                <div class="row" style="padding-top: 3%; ">
                                    ...
                                    <div class="col" >
                                        ...
                                        <select name="user_check" id="user_check">
                                            <option value="">--You are new user or not--</option>
