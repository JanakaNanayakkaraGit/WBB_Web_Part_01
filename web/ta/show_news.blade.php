        ...
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
            ...
            <div class="fh5co_suceefh5co_height"><img  src="{{ url('images/homepage/'.$new->newsimage) }}" alt="img"/>
                ...
                <div class="fh5co_suceefh5co_height_position_absolute_font">
                    ...
                    <div class=""><a href="{{route('web.ta.news.view', ['id' => $new->id])}}" class="fh5co_good_font"> {{ $new->news_title }}</a></div>
                </div>
            </div>
            @endforeach
        </div>
                ...
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="{{ url('images/homepage/'.$news->newsimage) }}" alt="img"/>
                        ...
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            ...
                            <div class=""><a href="{{route('web.ta.news.view', ['id' => $news->id])}}" class="fh5co_good_font_2">{{ substr(strip_tags($news->news_title), 0, 58) }} </a></div>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">செய்தி</div>
                </div>
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7 animate-box">
                        <a href="{{route('web.ta.news.view', ['id' => $all->id])}}" class="fh5co_magna py-1"> {{ $all->news_title }} </a> <a href="single.html" > - {{ \Carbon\Carbon::parse($news->created_at)->format('d-m-Y')}} </a>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom pt-3 py-2 mb-4">மிகவும் பிரபலமான</div>
                </div>
                ...
                <div class="row pb-3">
                    ...
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"><a href="{{route('web.ta.news.view', ['id' => $pop->id])}}"> {{ substr(strip_tags($pop->news_title), 0, 34) }}</a></div>
